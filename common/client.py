        ...
        try:
            with httpx.Client() as client:
                ...
                capabilities = AgentCapabilities(
                    ...
                    pushNotifications=card_data.get("capabilities", {}).get(
                        "pushNotifications", False
                    ),
                    stateTransitionHistory=card_data.get("capabilities", {}).get(
                ...
                return AgentCard(
                    ...
                    defaultInputModes=card_data.get(
                        "defaultInputModes", ["text/plain"]
                    ),
                    defaultOutputModes=card_data.get(
            ...
            logger.error(
                f"Failed to resolve agent card from {
                    self.agent_url}: {e}"
            )
            raise
