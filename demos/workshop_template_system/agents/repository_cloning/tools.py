...
@client_tool
def clone_repositories_for_workflow_tool(
    repository_url: str, workflow_type: str, workshop_name: str = ""
) -> str:
    """
    ...
    try:
        ...
        source_repos_dir = os.path.join(
            shared_workspace, "shared", "source-repositories"
        )
        working_dir = os.path.join(
            shared_workspace, "agents", "repository-cloning", "working"
        )
...
def clone_workflow1_repositories(
    repository_url: str,
    workshop_name: str,
    templates_dir: str,
...
def clone_workflow3_repositories(
    repository_url: str, workshop_name: str, source_repos_dir: str, working_dir: str
) -> Dict[str, Any]:
    ...
    shutil.copytree(
        workshop_repo_path, workshop_working_path, ignore=shutil.ignore_patterns(".git")
    )
