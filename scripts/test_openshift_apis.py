...
def test_end_to_end_workflow():
    ...
    validation_result = call_agent_api(
        "source_manager",
        "manage_workshop_repository_tool",
        {
            "operation": "validate",
