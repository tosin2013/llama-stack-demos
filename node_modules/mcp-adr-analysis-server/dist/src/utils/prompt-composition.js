 ...
 */
export function createAIDelegationPrompt(task, requirements, outputFormat, context) {
    const instructions = `
# AI Task Delegation
 ...
 */
export function addJSONSchema(prompt, schema) {
    const schemaSection = `
 ...
 */
export function validatePromptResponse(response, expectedFormat, requirements) {
    const result = {
        isValid: true,
        errors: [],
        warnings: [],
    ...
    if (requirements) {
        const missingRequirements = requirements.filter(req => !response.toLowerCase().includes(req.toLowerCase()));
 ...
 */
export function createFileAnalysisPrompt(filePaths, analysisType, outputSchema) {
    let prompt = `
 ...
 */
export function createProjectStructurePrompt(projectPath, includePatterns = [], excludePatterns = []) {
    return `
 ...
 */
export function escapePromptContent(content) {
    return content
        .replace(/\\/g, '\\\\')
        .replace(/`/g, '\\`')
        .replace(/\${/g, '\\${');
 ...
 */
export function truncatePrompt(prompt, maxLength) {
 ...
 */
export function createComprehensiveAnalysisPrompt(projectPrompt, filePrompt, additionalRequirements = []) {
 ...
 */
export function createADRAnalysisPrompt(adrDirectory, analysisType) {
    const requirements = [
...
JSON object with the following structure:
{
  ...
  "overallRecommendations": string[]
    ...
    return createAIDelegationPrompt(`Analyze ADRs in ${adrDirectory} for ${analysisType}`, requirements, outputFormat, { adrDirectory, analysisType });
}
/**
...
//# sourceMappingURL=prompt-composition.js.map