...
`;
        ...
        throw new McpAdrError(`Failed to generate cache initialization prompt: ${error instanceof Error ? error.message : String(error)}`, 'CACHE_ERROR');
    }
}
/**
...
`;
        ...
        throw new McpAdrError(`Failed to generate cache set prompt: ${error instanceof Error ? error.message : String(error)}`, 'CACHE_ERROR');
    }
}
/**
...
`;
        ...
        throw new McpAdrError(`Failed to generate cache get prompt: ${error instanceof Error ? error.message : String(error)}`, 'CACHE_ERROR');
    }
}
/**
 * Generate prompt for AI-driven cache validity check
 */
export async function hasValidCache(key) {
    try {
...
`;
        ...
        throw new McpAdrError(`Failed to generate cache validity check prompt: ${error instanceof Error ? error.message : String(error)}`, 'CACHE_ERROR');
    }
}
/**
...
`;
        ...
        throw new McpAdrError(`Failed to generate cache invalidation prompt: ${error instanceof Error ? error.message : String(error)}`, 'CACHE_ERROR');
    }
}
/**
...
`;
        ...
        throw new McpAdrError(`Failed to generate cache clear prompt: ${error instanceof Error ? error.message : String(error)}`, 'CACHE_ERROR');
    }
}
/**
...
`;
        ...
        throw new McpAdrError(`Failed to generate cache stats prompt: ${error instanceof Error ? error.message : String(error)}`, 'CACHE_ERROR');
    }
}
/**
...
`;
        ...
        throw new McpAdrError(`Failed to generate cache cleanup prompt: ${error instanceof Error ? error.message : String(error)}`, 'CACHE_ERROR');
    }
}
/**
 ...
 */
export async function getCachedOrGenerate(key, _generator, options = {}) {
    try {
...
`;
        ...
        throw new McpAdrError(`Failed to generate cache-or-generate prompt: ${error instanceof Error ? error.message : String(error)}`, 'CACHE_ERROR');
    }
}
