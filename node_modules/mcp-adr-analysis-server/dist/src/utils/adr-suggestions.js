 ...
 */
export async function analyzeImplicitDecisions(projectPath, existingAdrs) {
    try {
        const { generateImplicitDecisionDetectionPrompt } = await import('../prompts/adr-suggestion-prompts.js');
        const analysisPrompt = generateImplicitDecisionDetectionPrompt(projectPath, existingAdrs);
        const instructions = `
