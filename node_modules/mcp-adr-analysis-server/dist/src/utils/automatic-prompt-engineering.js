 ...
 */
export async function optimizePromptWithAPE(originalPrompt, config = {}) {
    try {
...
`;
        ...
        throw new McpAdrError(`Failed to generate APE optimization prompt: ${error instanceof Error ? error.message : String(error)}`, 'APE_OPTIMIZATION_ERROR');
    }
}
/**
 ...
 */
export async function generatePromptCandidates(basePrompt, strategies, candidateCount) {
    try {
...
`;
        ...
        throw new McpAdrError(`Failed to generate candidate generation prompt: ${error instanceof Error ? error.message : String(error)}`, 'CANDIDATE_GENERATION_ERROR');
    }
}
/**
 ...
 */
export async function evaluatePromptPerformance(candidates, evaluationCriteria, context = {}) {
    try {
...
`;
        ...
        throw new McpAdrError(`Failed to generate evaluation prompt: ${error instanceof Error ? error.message : String(error)}`, 'EVALUATION_ERROR');
    }
}
/**
 ...
 */
export async function optimizeToolPrompt(toolName, basePrompt, toolConfig) {
    try {
...
`;
        ...
        throw new McpAdrError(`Failed to generate tool optimization prompt: ${error instanceof Error ? error.message : String(error)}`, 'TOOL_OPTIMIZATION_ERROR');
    }
}
// ============================================================================
 ...
 */
function getSelectionStrategyDescription(strategy) {
    const descriptions = {
 ...
 */
function getToolOptimizationPriorities(toolName) {
    const priorities = {
 ...
 */
export function generateAPECacheKey(promptHash, config) {
 ...
 */
export function getDefaultAPEConfig() {
    return { ...DEFAULT_APE_CONFIG };
}
/**
 * Validate APE configuration
 */
export function validateAPEConfig(config) {
 ...
 */
export function getSupportedGenerationStrategies() {
    return [
        'template-variation',
        'semantic-variation',
        'style-variation',
 ...
 */
export function getSupportedSelectionStrategies() {
    return [
        'highest-score',
        'multi-criteria',
        'ensemble',
 ...
 */
export function createToolAPEConfig(toolName, customConfig = {}) {
    const toolConfigs = {
        'generate_adrs_from_prd': {
            candidateCount: 7,
...
//# sourceMappingURL=automatic-prompt-engineering.js.map