 ...
 */
export function generateEnvironmentSpecAnalysisPrompt(environmentFiles, projectStructure) {
    return `
 ...
 */
export function generateContainerizationDetectionPrompt(projectFiles) {
    return `
 ...
 */
export function generateAdrEnvironmentRequirementsPrompt(adrFiles) {
    return `
 ...
 */
export function generateEnvironmentCompliancePrompt(currentEnvironment, requirements, industryStandards) {
    return `
...
//# sourceMappingURL=environment-analysis-prompts.js.map