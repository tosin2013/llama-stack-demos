 ...
 */
export function generateResearchTopicExtractionPrompt(researchFiles, existingTopics) {
    return `
 ...
 */
export function generateResearchImpactEvaluationPrompt(researchTopics, existingAdrs) {
    return `
 ...
 */
export function generateAdrUpdateSuggestionPrompt(adrToUpdate, researchFindings, updateType) {
    return `
...
//# sourceMappingURL=research-integration-prompts.js.map