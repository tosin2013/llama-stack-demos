 ...
 */
export function generateAnalysisContext(projectStructure) {
    const context = {
 ...
 */
export function generateTechnologyDetectionPrompt(projectContext, packageJsonContent) {
    return `
 ...
 */
export function generatePatternDetectionPrompt(projectContext) {
    return `
 ...
 */
export function generateComprehensiveAnalysisPrompt(projectContext, packageJsonContent, additionalFiles) {
    return `
...
// Helper functions
function getFileTypeBreakdown(projectStructure) {
    const breakdown = {};
...
function isInterestingFile(filename, filepath) {
    ...
    return interestingPatterns.some(pattern => lowerFilename.includes(pattern) || lowerFilepath.includes(pattern));
}
