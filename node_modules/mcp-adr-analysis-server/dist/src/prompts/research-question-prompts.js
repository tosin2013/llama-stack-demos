 ...
 */
export function generateProblemKnowledgeCorrelationPrompt(problems, knowledgeGraph) {
    return `
 ...
 */
export function generateRelevantAdrPatternPrompt(researchContext, availableAdrs, availablePatterns) {
    return `
 ...
 */
export function generateContextAwareResearchQuestionsPrompt(researchContext, relevantKnowledge, projectContext) {
    return `
 ...
 */
export function generateResearchTaskTrackingPrompt(researchQuestions, currentProgress) {
    return `
...
//# sourceMappingURL=research-question-prompts.js.map