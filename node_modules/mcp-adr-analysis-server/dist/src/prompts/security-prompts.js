 ...
 */
export function generateSensitiveContentDetectionPrompt(content, contentType = 'general', userDefinedPatterns) {
    return `
 ...
 */
export function generateContentMaskingPrompt(content, detectedSensitiveItems, maskingStrategy = 'full') {
    return `
 ...
 */
export function generateCustomPatternConfigurationPrompt(projectContext, existingPatterns) {
    return `
...
//# sourceMappingURL=security-prompts.js.map